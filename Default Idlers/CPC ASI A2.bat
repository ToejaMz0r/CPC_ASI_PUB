...
start .\Expansion\beta\%arma2exe% "-mod=%arma2filepath%%cpcbasearma%;expansion;expansion\beta;expansion\beta\expansion;%cpclaunch%" %cpcadd% -connect=%cpcip% -port=%cpcport% %cpcname%
@echo.
@echo.
timeout /t %cpcinfo% /nobreak > NUL
