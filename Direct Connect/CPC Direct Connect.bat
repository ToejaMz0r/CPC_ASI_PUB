...
start ""  "%arma2filepath%%cpcopaon%\ArmA2OA_BE.exe" 0 0 -mod=%cpclaunch% %cpcname% %cpcadd% -password=%cpcpassword% -connect=%cpcip% -port=%cpcport% "-mod=%arma2filepath%%cpcbasearma%;expansion;"
timeout 15
@echo.
@echo.
